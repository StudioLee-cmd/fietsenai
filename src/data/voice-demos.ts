...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een klant met een kapotte e-bike belt; de agent vraagt naar merk en klacht en plant de reparatie in.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand wil de geplande onderhoudsbeurt verzetten naar zaterdag.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
