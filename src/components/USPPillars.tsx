...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor fietsenmakers" }, { href: "/chatbot", anchor: "ai chatbot voor fietsenmakers" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor fietsenmakers" }, { href: "/reviews", anchor: "review management voor fietsenmakers" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor fietsenmakers" }, { href: "/crm", anchor: "crm voor fietsenmakers" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor fietsenmakers" }],
    }
];
