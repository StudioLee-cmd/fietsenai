...
Onze [review-pakket](/review-pakket) levert standaard NFC-kaarten plus de juiste link en automatische opvolging.
...
- Lees onze pagina over [reviews](/reviews) voor een dieper script.

Lees ook onze pagina over [chatbot voor fietsenmakers](/chatbot) voor automatische opvolging na klachten.

## Hoe je dit vandaag invoert

1. **Vraag je Google review-link op:** ga naar Google Bedrijfsprofiel, deel knop, korte link.
2. **Bestel NFC-kaarten of print QR-stickers:** 50-100 stuks via een online printer voor 50-80 euro.
3. **Train alle medewerkers in dezelfde script:** korte zin, directe link.
4. **Maak WhatsApp-template:** snelle-antwoord met de opvolg-tekst.
5. **Plan dagelijks 5 minuten:** stuur opvolg-berichten naar alle klanten van 24-48 uur eerder.
6. **Review wekelijks:** hoeveel reviews binnen, welke 5 sterren, welke lager.

Onze [voice AI](/voice-ai) kan ook automatisch opvolgen via telefoon voor klanten die liever bellen dan tekstmessage. Bekijk onze [tarieven](/tarieven) als je dit volledig wilt laten opzetten.
...
NFC-kaarten 50-100 euro eenmalig, opvolg-berichten 0 euro (handmatig of via [gratis-website](/gratis-website) automatisering).
